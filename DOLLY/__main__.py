...
import config
from DOLLY import LOGGER, app, userbot
from DOLLY.core.call import NOTTY
from DOLLY.misc import sudo
...
async def init():
    ...
    for all_module in ALL_MODULES:
        importlib.import_module("DOLLY.plugins" + all_module)
    LOGGER("DOLLY.plugins").info("𝐀𝐥𝐥 𝐅𝐞𝐚𝐭𝐮𝐫𝐞𝐬 𝐋𝐨𝐚𝐝𝐞𝐝 𝐁𝐚𝐛𝐲🥳...")
    await userbot.start()
    await NOTTY.start()
