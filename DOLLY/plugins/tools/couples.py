...
#BOT FILE NAME
from DOLLY import app as app
from DOLLY.mongo.couples_db import _get_image, get_couple

POLICE = [
    [
        InlineKeyboardButton(
            text="𝐍𝐎𝐓𝐓𝐘 𝐁𝐎𝐘",
            url=f"https://t.me/NottySupport",
        ),
    ],
]
    ...
    try:
     ...
     #  if not is_selected:
         ...
         try:
            ...
            p1 = "DOLLY/assets/upic.png"
         try:
            p2 = await app.download_media(photo2.big_file_id, file_name="pfp1.png")
         except Exception:
            p2 = "NottySpace/assets/upic.png"
            
         img1 = Image.open(f"{p1}")
         img2 = Image.open(f"{p2}")

         img = Image.open("DOLLY/assets/cppic.png")
